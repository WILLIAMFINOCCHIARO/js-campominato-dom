...
for (let i = 1; i <= 100; i++) {
  ...
  Squareclass.classList.remove = ("active");
  Squareclass++;
  Squareclass.classList.add = ("active");
  }
...
function GridOttanta(params) {
  ...
  for (let i = 1; i <= 81; i++) {
    ...
    const container = document.querySelector(".container");
    // Aggiungo la classe Square
    elementSquare.className +="square" + [i];
    // Appendo al container
    container.append(elementSquare);
    console.log(elementSquare);
    // Aggiungo la classe Active
...
// Seleziono il comando play
let selectComandPlay = document.getElementById("gioca");
